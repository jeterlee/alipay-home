 ...
 * <pre>
 * Title: DragGridView
 * Description: 可拖动的 GridView， 结合 {@link com.github.jeterlee.alipayhome.adapter.MenuSelectAdapter}
 * 一起使用，注意只有 “我的应用” 中的可以拖动。
 * </pre>
 *
...
public class DragGridView extends GridView {
    ...
    /**
     * 重写该方法，达到使 GridView 适应 ScrollView 的效果
     */
    @Override
    ...
    private void swapItems(int x, int y) {
        ...
        if (endPosition != INVALID_POSITION && endPosition != currentPosition) {
            ...
            // 交换数据内容
            getDragAdapter().reOrder(currentPosition, endPosition);
